...
1. Create your own private copy of the assignment repository from
   ...
   repository for 'Assignment 04: Page Replacement Schemes, Clock Algorithm' at

   https://github.com/ahmet-kurt/csci430-assg04

   and select "Use this template" -> "Create a new repository".  Make
   sure the owner is your own GitHub account, name your repository
   `assg04-lastname` (using your own last name), and set the
...
your work and push it to the Feedback pull request of your GitHub
repository.
...
2. A zip archive of your final repository contents.  You can create
   ...
   `git archive --format=zip --output=assg04-submission.zip main`
